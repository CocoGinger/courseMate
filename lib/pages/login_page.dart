  ...
  void showInSnackBar(String value) {
    ...
    _scaffoldKey.currentState.showSnackBar(new SnackBar(
      content: new Text(
        ...
        style: TextStyle(
            color: Colors.white, fontSize: 16.0, fontFamily: "NotoSans-Bold"),
      ),
            ...
            Expanded(
              child: FlatButton(
                ...
                child: Text(
                  "Existing",
                  style: TextStyle(
                      color: left, fontSize: 16.0, fontFamily: "NotoSans-Bold"),
                ),
              ),
            ),
                      ...
                      Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintStyle: TextStyle(
                                fontFamily: "NotoSans-Bold", fontSize: 17.0),
                          ),
                        ),
                      ),
                      Container(
                      ...
                      Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: "Name",
                            hintStyle: TextStyle(
                                fontFamily: "NotoSans-Bold", fontSize: 16.0),
                          ),
                        ),
                      ),
                      Container(
